#ifdef _WIN32
#define _CRT_SECURE_NO_DEPRECATE // Ignore fopen deprecated error
#endif
...
void TGA_Texture_CubeMap(unsigned int textureArray) {
	...
	for (GLuint i = 0; i < 6; i++) {
		switch (i){
		case 0:
			pBitMap = Load_TGA("CubeMap/posx.tga");
			break;
		case 1:
			pBitMap = Load_TGA("CubeMap/negx.tga");
			break;
		case 2:
			pBitMap = Load_TGA("CubeMap/posy.tga");
			break;
		case 3:
			pBitMap = Load_TGA("CubeMap/negy.tga");
			break;
		case 4:
			pBitMap = Load_TGA("CubeMap/posz.tga");
			break;
		case 5:
			pBitMap = Load_TGA("CubeMap/negz.tga");
			break;
		default:
			exit(0);
			break;
